...
public class FossilHolder : Singleton<FossilHolder>
{
    ...
    public List<FossilInfo> fossilBits = new List<FossilInfo>() {
        ...
        new FossilInfo("Triceratops", FossilInfo.eDiet.HERBIVORE, "USA",
            "Three-horned Face \n Their remains are usually found individually, suggesting they may have spent much of their lives alone, which would be odd as prey animals often live together.",
            "9 meters long", "Late Cretaceous", "5500kg / 6 tons"),
    ...
    void Update()
    {
        ...
        {
            backpack.Add("Triceratops_Pelvis");
        }
